...
<body>
	...
	<table class="table " align="center">
		<tr width="100px">
			...
			<tr >
			<td >
				<a style="margin-bottom: 10px;" href="laporanTamuAnggota.php" target="_blank"><button class="btn btn-success bnt-sm">LAPORAN KUNJUNGAN ANGGOTA</button></a>
...
<form action="laporanNonAnggota.php" method="GET">
	<table class="table" align="center">
		<tr >
			...
			<tr>
			<td >
				<a  href="laporanNonAnggota.php" target="_blank"><button class="btn btn-success bnt-sm">LAPORAN KUNJUGAN NON ANGGOTA</button></a>
			</td>
		</tr>
