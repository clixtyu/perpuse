...
<h3 align="center">FORM ANGGOTA</h3>
	...
	<p  align="center" style=" margin-top:10px; font-weight: bold; color: red; font-family: arial;">Masukkan Nomor Keanggotaan Anda Pada Kolom Dibawah ini!</p>
<form action="" method="get">
	...
	<tr >
			...
			<td></td>
			<td>
				<input class="form-control" type="text" name="noanggota" placeholder="Masukkan ID Anggota" size="30">
			</td>
			<td></td>
...
?>
<hr/>
<i style="margin-left: 10px;">Created by IT Support SMAN 2 Kota Tangerang Selatan</i>
<?php 
