...
<form action="" method="post" enctype="multipart/form-data">
	<table class="table table-bordered" align="center">
		...
		<tr>
			...
			<td>:</td>
			<td>
				<input class="form-control" type="text" name="nama" placeholder="Masukkan Nama Calon Anggota" size="30">
			</td>
		</tr>
		<tr>
			<td>Asal Instasi</td>
			<td>:</td>
			<td>
				<input class="form-control" type="text" name="instasi" placeholder="Masukkan Nama Instasi" size="30">
			</td>
		</tr>
		<tr>
			<td>Alamat</td>
			<td>:</td>
			<td>
				<input class="form-control" type="text" name="alamat" placeholder="Masukkan Alamat Calon Anggota" size="30">
			</td>
		</tr>
		<tr>
			<td>Foto</td>
